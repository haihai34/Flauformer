...
class LoveDATrainDataset(Dataset):
    def __init__(self, data_root='D:/LoveDA/Train', img_dir='images_png', mosaic_ratio=0.25,
                 mask_dir='masks_convert', img_suffix='.png', mask_suffix='.png',
...
loveda_val_dataset = LoveDATrainDataset(data_root='D:/LoveDA/Val', mosaic_ratio=0.0,
                                        transform=val_aug)


class LoveDATestDataset(Dataset):
    def __init__(self, data_root='D:/LoveDA/Test', img_dir='images_png',
