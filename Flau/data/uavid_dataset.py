...
class UAVIDDataset(Dataset):
    def __init__(self, data_root, mode, img_dir, mask_dir,
...
if __name__ == "__main__":
    ...
    m = UAVIDDataset(data_root='E:/uavid_split/train')
    m.__getitem__(index=2)

#show_seg('D:/pycharm/Geoseg/data/uavid/out/segs','D:/pycharm/Geoseg/data/uavid/out/images',0)