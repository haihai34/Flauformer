...
def parse_args():
    ...
    parser.add_argument("--input-dir", default="E:/uavid/uavid/uavid_traintes")
    parser.add_argument("--output-img-dir", default="E:/uavid_split/traintes/img")
    parser.add_argument("--output-mask-dir", default="E:/uavid_split/traintes/mask")
